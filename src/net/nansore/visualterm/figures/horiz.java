 ...
 * @author boaz
 */
public class horiz extends Panel implements TermFigure {

    public horiz(Compound term, final TermContext context) throws TermVisualizationException, TermInstantiationException, PrologException {
        setLayout();
