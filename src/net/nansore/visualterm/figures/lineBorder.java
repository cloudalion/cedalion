...
public class lineBorder extends BorderFigure {

    public lineBorder(Compound term, TermContext parent) throws TermVisualizationException, TermInstantiationException, PrologException {
        super(term, parent);
    }
    ...
    protected Border createBorder(Compound term, TermContext context) throws TermVisualizationException {
        try {
            ...
            Color clr = color.createColor(term.arg(3), context);
